 ...
 * 
 */
package kr.ac.kaist.swrc.jhannanum.plugin.SupplementPlugin.MorphemeProcessor.KaistTagMappingLevel3;
 ...
 *
 */
public class KaistTagMappingLevel3 implements MorphemeProcessor {
	final private int TAG_LEVEL = 3;
	private HashMap<String,Eojeol> dupFilterMap = null;
	
	
	public KaistTagMappingLevel3() {
