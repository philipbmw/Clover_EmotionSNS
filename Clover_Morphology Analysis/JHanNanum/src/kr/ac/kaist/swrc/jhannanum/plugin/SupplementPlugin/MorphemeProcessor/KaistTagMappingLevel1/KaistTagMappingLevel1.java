 ...
 * 
 */
package kr.ac.kaist.swrc.jhannanum.plugin.SupplementPlugin.MorphemeProcessor.KaistTagMappingLevel1;
 ...
 *
 */
public class KaistTagMappingLevel1 implements MorphemeProcessor {
	final private int TAG_LEVEL = 1;
	private HashMap<String,Eojeol> dupFilterMap = null;
	
	
	public KaistTagMappingLevel1() {
