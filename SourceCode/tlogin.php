  ...
  if (!isset($_SESSION['user_id'])) {
    if (isset($_POST['submit'])) {
      ...
      if (!empty($user_email) && !empty($user_password)) {
        ...
        $query = "SELECT user_id, email FROM user WHERE email = '$user_email' AND password = SHA('$user_password')";
		$query1 = "INSERT INTO mention (email) VALUES ('$user_email')";	
