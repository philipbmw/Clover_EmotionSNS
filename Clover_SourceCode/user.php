...
$mentions = $connection->OAuthRequest("http://api.twitter.com/1/statuses/user_timeline.xml?user_id=$id","GET",array("count"=>"50"));
$xml = simplexml_load_string($mentions);

?>
  <article id =hgroup2><h4><center> &#10084User&#10084</center></hgroup2></h4>
